...
const getKiyimlar=()=>{
  let userRef=collection(db,"erkaklar-kiyimlari")
  ...
  const getOyoqKiyimlar=(category)=>{
    let userRef=collection(db,"erkaklar-kiyimlari")
    getDocs(userRef).then((res)=>{
      let arr=res.docs.map((item)=>{
        return {...item.data(),id:item.id}
 ...
 : <p>{x}</p>
        ...
        <div className='title'>
          <div className='left'>
            <h1 style={{fontFamily:"Raleway",}}>Erkaklar-kiyimlari</h1>
          </div>
          <div className='left-btns'>
           
              <button onClick={()=>getFudbolkalar("fudbolkalar")} style={{padding:"10px", borderRadius:"5px", border:"none",boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Fudbolkalar</button>
                <button onClick={()=>getShimlar("shimlar")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Shimlar</button>
                <button onClick={()=>getOyoqKiyimlar("oyoqkiyimlar")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Oyoq kiyimlar</button>
                <button onClick={()=>getShortiklar("shortiklar")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Shortiklar</button>
...
export default Erkaklar_kiyimlari