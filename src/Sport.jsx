...
const navigate=useNavigate()
  ...
  const getSport=()=>{
    let userRef=collection(db,"sport")
 ...
 : <p>{x}</p>
        ...
        <div className='title'>
          <div className='left'>
            <h1 style={{fontFamily:"Raleway",}}>Sport anjomlari</h1>
          </div>
          <div className='left-btns'>
           
                <button onClick={()=>getHordiq("hordiq")} style={{padding:"10px", borderRadius:"5px", border:"none",boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Sport va hordiq</button>
                <button onClick={()=>getAnjomlar("anjomlar")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Fudbol anjomlari</button>
                <button onClick={()=>getBaskedbol("baskedbol")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Baskedbol anjomlari</button>
                <button onClick={()=>getTennis("tennis")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Tennis anjomlari</button>
                <button onClick={()=>getSuzish("suzish")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Suzish anjomlari</button>
                <button onClick={()=>getUskunalar("uskunalar")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Sport uskunalar</button>
