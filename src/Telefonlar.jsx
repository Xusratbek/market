...
const getTelefonlar=()=>{
 ...
 : <p>{x}</p>
        ...
        <div className='title'>
          <div className='left'>
            <h1 style={{fontFamily:"Raleway",}}>Telefonlar</h1>
          </div>
          <div className='left-btns'>
           
              <button onClick={()=>getRedmi("redmi")} style={{padding:"10px", borderRadius:"5px", border:"none",boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Redmi</button>
                <button onClick={()=>getSamsung("samsung")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Samsung</button>
                <button onClick={()=>getIphone("iphone")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Iphone</button>
                <button onClick={()=>getHonor("xonor")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Honor</button>
                <button onClick={()=>getNokia("nokia")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Nokia</button>
          ...
          <div className='clear'>
            {
              products.map((item)=>(
                <div style={{boxShadow:" 1px 2px 16px 3px rgba(54, 58, 69, 0.08)", width:"180px", height:"fit-content", borderRadius:"8px", padding:"15px", background:"#FFFFFF"}}>
