...
const MaishiyTexnika = () => {
  ...
  const getElektronika=()=>{
    let userRef=collection(db,"texnika")
  ...
  const getVentilyatorlar=(category)=>{
    let userRef=collection(db,"texnika")
    getDocs(userRef).then((res)=>{
      let arr=res.docs.map((item)=>{
        return {...item.data(),id:item.id}
 ...
 : <p>{x}</p>
        ...
        <div className='title'>
          <div className='left'>
            <h1 style={{fontFamily:"Raleway",}}>Maishiy-Texnika</h1>
          </div>
          <div className='left-btns'>
           
              <button onClick={()=>getDazmol("dazmollar")} style={{padding:"10px", borderRadius:"5px", border:"none",boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Dazmollar</button>
                <button onClick={()=>getVentilyatorlar("ventilyatorlar")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Ventilyatorlar</button>
                <button onClick={()=>getPlisoslar("plisoslar")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Plisoslar</button>
                <button onClick={()=>getFenlar("fenlar")} style={{padding:"10px",border:"none", borderRadius:"5px", boxShadow:"0px 4px 12px 0px rgba(54, 58, 69, 0.2)"}}>Fenlar</button>
